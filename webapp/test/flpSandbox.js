		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cedula inversa",
									"targetURL": "#mabecedulainversa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mabecedulainversa-display": {
								"semanticObject": "mabecedulainversa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mabe.cedulainversa",
									"url": sap.ui.require.toUrl("mabe/cedulainversa")
								}
							}
						}
					}
